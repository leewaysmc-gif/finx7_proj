      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center relative z-10">
        <div className="flex justify-center">
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-r from-orange-300 to-gray-900 rounded-3xl blur opacity-75"></div>
            <img
              src={logo}
              alt="About us"
        ...
        <div className="text-left space-y-6">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-orange-300 via-orange-300 to-orange-300 bg-clip-text text-transparent drop-shadow-lg">
            About Us
          </h2>
          ...
          <Link
            to="/blogs"
            className="px-10 py-4 bg-gradient-to-r from-orange-300 via-orange-400 to-yellow-500 text-gray-900 font-bold text-lg rounded-2xl shadow-xl hover:shadow-orange-300/50 hover:scale-105 transform transition duration-300 border-2 border-orange-300/30 inline-block text-center"
          >
            Learn More About Us
          </Link>
        </div>
