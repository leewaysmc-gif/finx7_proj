    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-left md:text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-gradient-to-r from-orange-300 to-orange-300 bg-clip-text mb-6 drop-shadow-lg">
            Contact Us
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <form
            ...
            noValidate
          >
            <div className="absolute -inset-px bg-gradient-to-r from-orange-300/20 to-yellow-400/20 rounded-3xl blur opacity-50"></div>

            <div className="relative grid md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                <label className="text-orange-300 font-medium mb-2 text-sm uppercase tracking-wider">
                  Your Name
                </label>
                <input
                  type="text"
                ...
                />
                {errors.name && (
                  <span className="text-red-400 mt-2 text-sm flex items-center gap-1">
                    ⚠ {errors.name}
                  </span>
                )}
              </div>
...
const ContactInfoItem = ({ Icon, label, value, href }) => (
  <div className="flex items-center gap-4">
    ...
    <div>
      ...
      {href ? (
        <a href={href} className="text-white hover:text-orange-300 transition-colors text-lg font-medium">
          {value}
        </a>
      ) : (
